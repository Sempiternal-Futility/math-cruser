...
void draw_one()
{
   move(MID_YPOS -9, MID_XPOS -21);
   printw("  ██  ");

   move(MID_YPOS -8, MID_XPOS -21);
   printw(" ███  ");

   move(MID_YPOS -7, MID_XPOS -21);
   printw("  ██  ");

   move(MID_YPOS -6, MID_XPOS -21);
   printw("  ██  ");

   move(MID_YPOS -5, MID_XPOS -21);
   printw("██████");
}
...
void draw_four()
{
	move(MID_YPOS -3, MID_XPOS -21);
	printw("██  ██");

	move(MID_YPOS -2, MID_XPOS -21);
	printw("██  ██");

	move(MID_YPOS -1, MID_XPOS -21);
	printw("██████");

	move(MID_YPOS, MID_XPOS -21);
	printw("    ██");
